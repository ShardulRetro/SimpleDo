...
import de.gruenbaum.simpledo.adapters.NotesAdapter;
...
public class MainActivity extends AppCompatActivity implements NotesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (noteList.size() != 0) { // Fix: Remove spaces around !=
    ...
    public void onNoteClicked(Note note, int position) {
        ...
        Intent intent = new Intent (getApplication(), CreateNoteActivity.class);
        intent.putExtra("isViewOrUpdate", true);
        intent.putExtra("note", note);
        startActivityForResult(intent, REQUEST_CODE_UPDATE_NOTE);
    }

    private void getNotes(final int reqestCode, final boolean isNoteDeleted) {
        ...
        class GetNotesTask extends AsyncTask<Void, Void, List<Note>> {
            ...
            protected void onPostExecute(List<Note> notes) {
                ...
                if(reqestCode == REQUEST_CODE_SHOW_NOTES){
        ...
        // Create an instance of the correct AsyncTask class: GetNotesTask
